...
CREATE TABLE MNG_EQ_REPAIR_REQUEST (
    ...
    constraint FK_Request_User foreign key (REQ_ID_USER) references MNG_EQ_USER(USR_ID)
)
GO
...
CREATE TABLE MNG_EQ_REPAIR_HISTORY (
	...
	RH_ID_TECHNICAL int null, --info staff technical fix ticket
    ...
    constraint FK_RepairHis_User foreign key (RH_ID_TECHNICAL) references MNG_EQ_USER(USR_ID),
...
CREATE TABLE MNG_EQ_USAGE_HISTORY (
	...
	constraint FK_UsageHis_Dept foreign key (UH_ID_DEPT) references MNG_EQ_DEPARTMENT(DEPT_ID),
)
GO
